...
public class main {
	...
	private static boolean iniciarSessio() {
		//CARREGAR RANKING
		System.out.println("estic principi iniciar sessio");
		String nom, pwd;
		nom = "";
		pwd = "";
		...
		case 1:
			...
			System.out.println("estic despres de llegir usuari");
			if (b) {
		...
		case 2:
			...
			if (cData.escriureUsuari(nom, pwd)) {
				System.out.println("nouUser");
				cUsr.nouUsuari(nom, pwd);
				System.out.println("passat nou user");
	...
	private static void novaPartida() {
		...
		case 2:
			...
			if (cPartida.getAcabada()) {
				System.out.println("estic escrivint al ranking");
		...
		case 3:
			...
			p.inGame();
			System.out.println("p.getAcabada():"+p.getAcabada());
			if (p.getAcabada()) {
				System.out.println("estic escrivint al ranking");
